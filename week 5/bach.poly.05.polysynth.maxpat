...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 788.0, 369.0, 150.0, 60.0 ],
					"text" : "sends messages to our polyobject that allow us to see the mute and busy states"
				}
...
,
					"patching_rect" : [ 709.0, 375.0, 75.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 902.0, 551.0, 50.0, 22.0 ],
					"text" : "1 0 0 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 757.0, 551.0, 93.0, 22.0 ],
					"text" : "0 1 1 0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 866.952475247524944, 269.0, 59.0, 22.0 ],
					"text" : "mute 1, 0"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 866.952475247524944, 311.0, 60.0, 22.0 ],
					"text" : "s mute.all"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 598.952475247524944, 375.0, 79.0, 22.0 ],
					"text" : "prepend note"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 649.25, 628.0, 258.0, 33.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 649.25, 613.0, 63.0, 20.0 ],
					"text" : "<ezdac~>",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 599.0, 613.0, 48.25, 48.25 ]
				}
...
, 			{
				"box" : 				{
					...
					"parameter_enable" : 1,
					"patching_rect" : [ 599.0, 556.0, 136.0, 47.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 942.952475247524944, 499.0, 97.0, 33.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "signal", "", "", "" ],
					"patching_rect" : [ 598.952475247524944, 499.0, 328.0, 33.0 ],
					"text" : "poly~ simple.voice.polycore.v1 4"
				}
...
, 			{
				"name" : "simple.voice.polycore.v1.maxpat",
				"bootpath" : "~/Desktop/CSS/sound-synth-tech-/week 5",
				"patcherrelativepath" : ".",
				"type" : "JSON",
				"implicit" : 1
			}
...
, 			{
		...
		"autosave" : 0,
		"bgcolor" : [ 1.0, 0.756862745098039, 0.992156862745098, 1.0 ]
	}
